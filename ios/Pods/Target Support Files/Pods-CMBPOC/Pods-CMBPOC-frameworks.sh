...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/RNCmbSdk/cmbSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/RNCmbSdk/CMBCrossPlatform.framework"
fi
