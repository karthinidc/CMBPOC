...
install_xcframework "${PODS_ROOT}/../../node_modules/cmbsdk-react-native/ios/SDK/cmbsdk-ios-binary/framework/cmbSDK/device_simulator/cmbSDK.xcframework" "RNCmbSdk" "framework" "ios-arm64_armv7" "ios-x86_64-simulator"
install_xcframework "${PODS_ROOT}/../../node_modules/cmbsdk-react-native/ios/SDK/cmbsdk-crossplatform-ios-binary/CMBCrossPlatform.xcframework" "RNCmbSdk" "framework" "ios-x86_64-simulator" "ios-arm64_armv7"
