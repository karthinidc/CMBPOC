...
public class RCTCmbSdkModule extends ReactContextBaseJavaModule {
    ...
    // Response helpers
    private APIResponseListener createResponseListener(@NonNull final Promise apResult) {
    ...
    private APIResponseListener createCommandResponseListener(@NonNull final String commandID, @NonNull final String eventType, @Nullable final String command) {
